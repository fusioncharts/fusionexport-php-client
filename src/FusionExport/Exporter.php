...
class Exporter
{
    ...
    public function __construct(ExportConfig $exportConfig, $minifyResources=false, $exportBulk=true)
    {
    ...
    public function setExportConnectionConfig($exportServerHost, $exportServerPort, $isSecure)
    {
		...
		public function sendToServer() {
			...
			$configData = $this->exportConfig->getFormattedConfigs($this->minifyResources, $this->exportBulk);
